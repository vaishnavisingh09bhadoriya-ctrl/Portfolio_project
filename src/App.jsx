...
function App() {
 ...
 <div  className=" min-h-screen bg-linear-to-bl from-sky-200 to-white text-gray-900   antialiased">
      ...
      <div className=" max-w-6xl mx-auto   ">
        ...
        <header  className=" sticky top-0 z-50  bg-linear-to-bl from-sky-700 to-gray-800 shadow-sm flex px-5 h-12 gap-6 justify-between mb-6 rounded-lg">
          <div className="  flex items-center gap-5 md:gap-8">
           <span className='font-extrabold text-lg'> VAISHNAVI</span>
          </div>
          <div className=' flex justify-center items-center gap-3 md:gap-8 text-sm'>
           ...
           <div  className='nav-simple text-shadow-lg'><button onClick={() => scrollToSection("contact")}><a href="#contact">Contact</a></button></div>
                  <div class="container-after" className='flex  items-center justify-center overflow-hidden px-2 py-1 ml-1'>
       <input type="checkbox" id="check" className='inpt'></input>
        <label htmlFor="check" className="button-after"onClick={handleToggle}
></label></div>
...
<div className=' card relative isolate mb-5 h-64 w-64 '>
          ...
          <section  id="projects" className=" card mb-6 px-6  flex flex-col items-center   justify-center "> <div className='text-center m-8'><h1  className='font-bold text-3xl'>Skills</h1></div>
            ...
            <div className=" skills mb-2 shadow-lg px-4 py-3 w-50 h-15  bg-linear-to-bl from-sky-700 to-gray-800 text-center rounded-lg shadow-grey-100">HTML</div>
            <div className=" skills mb-2 shadow-lg px-4 py-3 w-50 h-15   bg-linear-to-bl from-sky-700 to-gray-800 text-center rounded-lg shadow-grey-100">CSS</div>
            <div className=" skills mb-2 shadow-lg px-4 py-3 w-50 h-15   bg-linear-to-bl from-sky-700 to-gray-800 text-center rounded-lg shadow-grey-100">JavaScript</div>
            <div className=" skills mb-2 shadow-lg px-4 py-3 w-50 h-15  bg-linear-to-bl from-sky-700 to-gray-800 text-center rounded-lg shadow-grey-100">DOM</div>
            <div className=" skills mb-2 shadow-lg px-4 py-3 w-50 h-15   bg-linear-to-bl from-sky-700 to-gray-800 text-center rounded-lg shadow-grey-100">Responsive design</div>
            <div className=" skills mb-2 shadow-lg px-4 py-3 w-50 h-15   bg-linear-to-bl from-sky-700 to-gray-800 text-center rounded-lg shadow-grey-100">UI development</div>
            <div className=" skills mb-2 shadow-lg px-4 py-3 w-50 h-15   bg-linear-to-bl from-sky-700 to-gray-800 text-center rounded-lg shadow-grey-100">Git & Github</div>
            <div className=" skills mb-2 shadow-lg px-4 py-3 w-50 h-15   bg-linear-to-bl from-sky-700 to-gray-800 text-center rounded-lg shadow-grey-100" >API handeling</div>
            <div className=" skills mb-2 shadow-lg px-4 py-3 w-50 h-15   bg-linear-to-bl from-sky-700 to-gray-800 text-center rounded-lg shadow-grey-100">React</div></div>
...
<div className='flex items-center justify-center text-center mb-1 w-full py-5'>
     ...
     : <>
      <header  className=" sticky top-0 z-50  bg-linear-to-bl from-sky-200 to-white shadow-sm flex px-5 h-12 gap-5  justify-between mb-6 rounded-lg">
